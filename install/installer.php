...
if(!is_file("$mod_db")) {
	...
	$sql_entries_table = generate_sql_query("../modules/alp.mod/install/tpl-entries.php");
	$sql_prefs_table = generate_sql_query("../modules/alp.mod/install/tpl-preferences.php");
...
if($prefs_version < $mod['version']) {
	...
	$all_tables = glob("../modules/alp.mod/install/tpl-*.php");
